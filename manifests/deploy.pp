...
class n1k_vsm::deploy
{
  ...
  if (inline_template("<%= @tmp_mac_base.length %>") < 7) {
    ...
    $_vmb = split($tmp_mac_base, '')
  }

  notify {"Arg: input mac ${n1k_vsm::vsm_mac_base} filtered ${tmp_mac_base} final ${_vmb}" : withpath => true}

  # TODO: Generate MACs for VSM
  $ctrlmac  = "52:54:${_vmb[0]}${_vmb[1]}:${_vmb[2]}${_vmb[3]}:${_vmb[4]}${_vmb[5]}:${_vmb[6]}1"
  $mgmtmac  = "52:54:${_vmb[0]}${_vmb[1]}:${_vmb[2]}${_vmb[3]}:${_vmb[4]}${_vmb[5]}:${_vmb[6]}2"
  $pktmac   = "52:54:${_vmb[0]}${_vmb[1]}:${_vmb[2]}${_vmb[3]}:${_vmb[4]}${_vmb[5]}:${_vmb[6]}3"
  ...
  if !($n1k_vsm::pacemaker_control) {
    ...
    $pkttap_s   = 'vsm-pkt1'
    # TODO: Generate MACs
    $ctrlmac_s  = "52:54:${_vmb[0]}${_vmb[1]}:${_vmb[2]}${_vmb[3]}:${_vmb[4]}${_vmb[5]}:${_vmb[6]}4"
    $mgmtmac_s  = "52:54:${_vmb[0]}${_vmb[1]}:${_vmb[2]}${_vmb[3]}:${_vmb[4]}${_vmb[5]}:${_vmb[6]}5"
    $pktmac_s   = "52:54:${_vmb[0]}${_vmb[1]}:${_vmb[2]}${_vmb[3]}:${_vmb[4]}${_vmb[5]}:${_vmb[6]}6"
