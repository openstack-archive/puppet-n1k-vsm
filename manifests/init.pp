...
#
# [*vsm_mgmt_ipv6*]
#  (required) IPv6 address of the management interface on the Nexus1000v VSM
#
# [*vsm_mgmt_netmaskv6*]
#  (required) IPv6 netmask of the management interface of the Nexus1000v VSM
#
# [*vsm_mgmt_gatewayv6*]
#  (required) IPv6 of the default gateway for the management interface of the Nexus1000v VSM
#
# [*n1kv_source*]
