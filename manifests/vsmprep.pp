...
#  }
  ...
  exec { 'Exec_VSM_Repackage_Script':
    command => "/tmp/repackiso.py -i/var/spool/cisco/vsm/${n1k_vsm::n1kv_version}.iso -d${n1k_vsm::vsm_domain_id} -n${n1k_vsm::vsmname} -m${n1k_vsm::mgmtip} -s${n1k_vsm::mgmtnetmask} -g${n1k_vsm::mgmtgateway} --mgmtipv6${n1k_vsm::mgmtipv6} --mgmtsubnetv6${n1k_vsm::mgmtnetmaskv6} --gatewayv6${n1k_vsm::mgmtgatewayv6} -p${n1k_vsm::vsm_admin_passwd} -r${n1k_vsm::vsm_role} -f/var/spool/cisco/vsm/${n1k_vsm::vsm_role}_repacked.iso ",
